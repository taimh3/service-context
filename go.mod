...
require (
	github.com/gocql/gocql v1.15.2
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/v2/mongo/otelmongo v0.0.0-20250604092405-64b6ffc9f123
